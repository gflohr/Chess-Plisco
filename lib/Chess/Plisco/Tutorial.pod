...
sufficient for copying a L<Chess::Plisco> which makes the copying really
...
from L<Chess::Plisco::Macro> for it:
...
You should also use a macro from L<Chess::Plisco::Macro>:
