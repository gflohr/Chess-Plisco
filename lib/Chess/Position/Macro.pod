...
Same as L<Chess::Position/moveTo> but modifies B<MOVE> directly.
...
Same as L<Chess::Position/moveFrom> but modifies B<MOVE> directly.
...
Same as L<Chess::Position/movePiece> but modifies B<MOVE> directly.
