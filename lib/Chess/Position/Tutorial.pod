...
L<Chess::Position/doMove> to the move.  They are I<not> set, when calling
L<Chess::Position/pseudoLegalMoves> or L<Chess::Position/pseudoLegalAttacks>! 
...
You should also use a macro from L<Chess::Position::Macro>:
    ...
    $en_passant_shift = cp_pos_en_passant_shift $pos;
